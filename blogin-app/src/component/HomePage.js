                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="card-footer">
                      <div><button className="btn1-style" onClick={() => setCount(count + 1)}><strong>{count}</strong><AiFillLike size={25}/></button></div>
                      <div><button className="btn2-style" onClick={() => setCount(count + 1)}><strong>{count}</strong><AiFillDislike size={25}/></button></div>
                    </div>
                    <br/><br/><br/><br/>
                    <div>
